...
RESULT_DIR = 'results/intra_pure_physformer'
LOG = os.path.join(RESULT_DIR, 'log.txt')
LIVE_FILE = os.path.join('results', 'live_progress_intra_pure_phys.md')
STATUS_FILE = os.path.join('results', 'current_status_intra_pure_phys.json')
...
def run_experiment(train_name, train_path, test_name, test_path):
    ...
    # PhysFormer baseline (full MHSA, no BiFormer) for fair comparison

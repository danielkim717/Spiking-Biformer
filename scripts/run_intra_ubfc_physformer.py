...
RESULT_DIR = 'results/intra_ubfc_physformer'
LOG = os.path.join(RESULT_DIR, 'log.txt')
LIVE_FILE = os.path.join('results', 'live_progress_intra_ubfc_phys.md')
STATUS_FILE = os.path.join('results', 'current_status_intra_ubfc_phys.json')
